#!/usr/bin/env python3
"""Render an XLSX to a PDF and PNG pages for workbook visual QA."""
...
def main():
    ...
    if not pdf.exists() or not converter: raise SystemExit("PDF or pdftoppm unavailable; cannot create page images.")
